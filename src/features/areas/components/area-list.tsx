      ...
      <div className="absolute right-3 top-3 z-20">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => archive.mutate()}><Archive />Archive</DropdownMenuItem>
            <DropdownMenuItem className="text-destructive" onClick={() => { if (window.confirm(`Permanently delete ${area.name}?`)) remove.mutate(); }}><Trash2 />Delete</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
